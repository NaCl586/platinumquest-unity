...
[
    ...
    VolumeComponentMenuForRenderPipeline(
        "Lighting/Screen Space Reflection (URP)",
...
public class ScreenSpaceReflection : VolumeComponent, IPostProcessComponent
{
    ...
    public SSRAlgorithmParameter algorithm = new(
        value: Algorithm.Approximation,
        overrideState: false
    );
    ...
    public ClampedFloatParameter minSmoothness = new(
        value: 0.4f,
        min: 0.0f,
        max: 1.0f,
        overrideState: false
    ...
    [
        ...
        Tooltip(
            "Use the slider to set the smoothness value at which SSR reflections begin to fade out."
        )
    ]
    public ClampedFloatParameter fadeSmoothness = new(
        value: 0.6f,
        min: 0.0f,
        max: 1.0f,
        overrideState: false
    ...
    public ClampedFloatParameter edgeFade = new(
        value: 0.1f,
        min: 0.0f,
        max: 1.0f,
        overrideState: true
    ...
    public SSRThicknessParameter thicknessMode = new(
    ...
    public ClampedFloatParameter thickness = new(
        value: 0.25f,
        min: 0.0f,
        max: 1.0f,
        overrideState: true
    ...
    public ClampedFloatParameter accumFactor = new(
        value: 0.75f,
        min: 0.0f,
        max: 1.0f,
        overrideState: false
    ...
    public sealed class SSRStateParameter : VolumeParameter<State>
    {
        ...
        public SSRStateParameter(State value, bool overrideState = false)
    ...
    public enum Algorithm
    {
        ...
        [
            ...
            Tooltip(
                "Cast rays in stochastic directions and accumulate multiple frames to compute rough reflections."
            )
        ]
        PBRAccumulation = 1,
    }
    ...
    public sealed class SSRAlgorithmParameter : VolumeParameter<Algorithm>
    {
        ...
        /// <param name="value">The initial value to store in the parameter.</param>
        /// <param name="overrideState">The initial override state for the parameter.</param>
        public SSRAlgorithmParameter(Algorithm value, bool overrideState = false)
            : base(value, overrideState) { }
    }
    ...
    public sealed class SSRThicknessParameter : VolumeParameter<ThicknessMode>
    {
        ...
        /// <param name="value">The initial value to store in the parameter.</param>
        /// <param name="overrideState">The initial override state for the parameter.</param>
        public SSRThicknessParameter(ThicknessMode value, bool overrideState = false)
            : base(value, overrideState) { }
    }
    ...
    public sealed class SSRQualityParameter : VolumeParameter<Quality>
    {
        ...
        /// <param name="value">The initial value to store in the parameter.</param>
        /// <param name="overrideState">The initial override state for the parameter.</param>
        public SSRQualityParameter(Quality value, bool overrideState = false)
            : base(value, overrideState) { }
    }
}
